function [ z ] = roccio_classifier_expdata(term_weighting_scheme,feature_size,feature_selection_method,dataset_type,tokenization_type,usestopwordremoval,uselowercase,usestemming)
...
% DATASET_SPAM_YOUTUBE_COMMENT = 21;
% DATASET_SENTIMENT_LABELLED_SENTENCES = 22;
% DATASET_SENTIMENT140_SPLITTED_SUBSET = 23;
% 
...
% elseif dataset_type==DATASET_SPAM_YOUTUBE_COMMENT
%     resfoldername='experiments_with_spam_youtube_comment';
% elseif dataset_type==DATASET_SENTIMENT_LABELLED_SENTENCES
%     resfoldername='experiments_with_sentiment_labelled_sentences';
% elseif dataset_type==DATASET_SENTIMENT140_SPLITTED_SUBSET
%     resfoldername='experiments_with_sentiment140_splitted_subset';
% end
...
%dataset_train=dataset(train_matrix,topic_matrix(:,1));
%dataset_test=dataset(test_matrix);
%[~,K,~] = knnc(dataset_train);
predicted_labels = roccio(train_matrix,topic_matrix,test_matrix,dataset_class_idx,term_feature);
...
% if dataset_type==DATASET_REUTERS
%     resfoldername='experiments_with_reuters_21578';
%     finalresults=strcat('C:\googledriveakuysal\academic\kod\term_weighting_experiments\reutersexperiments\',finalresults);
%     finalmatrix=strcat('C:\googledriveakuysal\academic\kod\term_weighting_experiments\reutersexperiments\',finalmatrix);
%     filename=strcat('C:\googledriveakuysal\academic\kod\term_weighting_experiments\reutersexperiments\',filename);
% elseif dataset_type==DATASET_MILLIYET
%     resfoldername='experiments_with_milliyet_collection';
...
% elseif dataset_type==DATASET_SPAM_YOUTUBE_COMMENT
%     resfoldername='experiments_with_spam_youtube_comment';
%     finalresults=strcat('spamyoutubecommentexperiments\',finalresults);
%     finalmatrix=strcat('spamyoutubecommentexperiments\',finalmatrix);
%     filename=strcat('spamyoutubecommentexperiments\',filename);
% elseif dataset_type==DATASET_SENTIMENT_LABELLED_SENTENCES
%     resfoldername='experiments_with_sentiment_labelled_sentences';
%     finalresults=strcat('sentimentlabelledsentencesexperiments\',finalresults);
%     finalmatrix=strcat('sentimentlabelledsentencesexperiments\',finalmatrix);
%     filename=strcat('sentimentlabelledsentencesexperiments\',filename); 
% end

if dataset_type==DATASET_REUTERS
    resfoldername='experiments_with_reuters_21578';
    finalresults=strcat('C:\googledriveakuysal\academic\kod\term_weighting_experiments\reutersexperiments\rocc\',finalresults);
    finalmatrix=strcat('C:\googledriveakuysal\academic\kod\term_weighting_experiments\reutersexperiments\rocc\',finalmatrix);
    filename=strcat('C:\googledriveakuysal\academic\kod\term_weighting_experiments\reutersexperiments\rocc\',filename);
elseif dataset_type==DATASET_MILLIYET
    resfoldername='experiments_with_milliyet_collection';
    finalresults=strcat('C:\googledriveakuysal\academic\kod\term_weighting_experiments\milliyetexperiments\',finalresults);
    finalmatrix=strcat('C:\googledriveakuysal\academic\kod\term_weighting_experiments\milliyetexperiments\',finalmatrix);
...
elseif dataset_type==DATASET_SPAM
    resfoldername='experiments_with_spam';
    finalresults=strcat('spamexperiments\rocc\',finalresults);
    finalmatrix=strcat('spamexperiments\rocc\',finalmatrix);
    filename=strcat('spamexperiments\rocc\',filename);         
elseif dataset_type==DATASET_NEWS2C
    resfoldername='experiments_with_news2c';
...
result_fpath=strcat('C:\googledriveakuysal\academic\kod\term_weighting_experiments\',resfoldername,'\rocres.txt');
