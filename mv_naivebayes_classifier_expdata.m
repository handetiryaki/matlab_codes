function [ z ] = mv_naivebayes_classifier_expdata(term_weighting_scheme,feature_size,feature_selection_method,dataset_type,tokenization_type,usestopwordremoval,uselowercase,usestemming)
...
eval(['load ', strcat(destination_fpath,'train_matrix.mat'), '  train_matrix topic_matrix train_matrix_without_weighting'])
...
if dataset_type==DATASET_REUTERS
    resfoldername='experiments_with_reuters_21578';
    finalresults=strcat('C:\googledriveakuysal\academic\kod\term_weighting_experiments\reutersexperiments\nbcmv\',finalresults);
    finalmatrix=strcat('C:\googledriveakuysal\academic\kod\term_weighting_experiments\reutersexperiments\nbcmv\',finalmatrix);
    filename=strcat('C:\googledriveakuysal\academic\kod\term_weighting_experiments\reutersexperiments\nbcmv\',filename);
elseif dataset_type==DATASET_MILLIYET
    resfoldername='experiments_with_milliyet_collection';
...
elseif dataset_type==DATASET_SPAM
    resfoldername='experiments_with_spam';
    finalresults=strcat('spamexperiments\nbcmv\',finalresults);
    finalmatrix=strcat('spamexperiments\nbcmv\',finalmatrix);
    filename=strcat('spamexperiments\nbcmv\',filename);         
elseif dataset_type==DATASET_NEWS2C
    resfoldername='experiments_with_news2c';
...
result_fpath=strcat('C:\googledriveakuysal\academic\kod\term_weighting_experiments\',resfoldername,'\nbcmvres.txt');
